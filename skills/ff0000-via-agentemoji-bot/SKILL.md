---
name: ff0000-via-agentemoji-bot
description: Insert premium custom emoji from "Свои эмодзи • #ff0000 (via @agentemoji_bot)" into Telegram content. Use when writing Telegram постов и сообщений в Telegram that should include premium emoji, or when the user mentions "Свои эмодзи • #ff0000 (via @agentemoji_bot)" emoji.
---

# Свои эмодзи • #ff0000 (via @agentemoji_bot) — Telegram premium emoji
