---
name: useless-emotes-by-waifuch
description: Insert premium custom emoji from "Useless Emotes by @waifuch" into Telegram content. Use when writing Telegram постов и сообщений в Telegram that should include premium emoji, or when the user mentions "Useless Emotes by @waifuch" emoji.
---

# Useless Emotes by @waifuch — Telegram premium emoji
