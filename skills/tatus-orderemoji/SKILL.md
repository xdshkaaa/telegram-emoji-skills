---
name: tatus-orderemoji
description: Insert premium custom emoji from "𝖲𝗍𝖺𝗍𝗎𝗌 - @OrderEmoji" into Telegram content. Use when writing Telegram постов и сообщений в Telegram that should include premium emoji, or when the user mentions "𝖲𝗍𝖺𝗍𝗎𝗌 - @OrderEmoji" emoji.
---

# 𝖲𝗍𝖺𝗍𝗎𝗌 - @OrderEmoji — Telegram premium emoji
...
171 emoji, fallback + id + ready snippet: [references/emoji-catalog.md](references/emoji-catalog.md)
