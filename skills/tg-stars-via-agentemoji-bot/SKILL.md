---
name: tg-stars-via-agentemoji-bot
description: Insert premium custom emoji from "TG Stars • 🌅 Закат (via @agentemoji_bot)" into Telegram content. Use when writing Telegram постов и сообщений в Telegram that should include premium emoji, or when the user mentions "TG Stars • 🌅 Закат (via @agentemoji_bot)" emoji.
---

# TG Stars • 🌅 Закат (via @agentemoji_bot) — Telegram premium emoji
...
35 emoji, fallback + id + ready snippet: [references/emoji-catalog.md](references/emoji-catalog.md)
